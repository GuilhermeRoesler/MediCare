...
<main class="main-content">
    ...
    <script>
        ...
        new Chart(document.getElementById('especialidadeChart'), {
            type: 'pie',
            data: { labels: <?php echo json_encode($relatorio3_labels); ?>, datasets: [{ data: <?php echo json_encode($relatorio3_data); ?>, backgroundColor: ['#3b5bdb', '#10b981', '#ef4444', '#f59e0b', '#6b7280'] }] },
