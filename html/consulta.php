...
<main class="main-content">
    ...
    <section class="management-card">
        <div class="management-header">
            ...
            <a href="cadastroConsulta.html" class="btn-primary new-item-btn">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Consulta de rotina</td>
                             <td class="actions">
                                <a href="atualizarConsulta.html" class="action-icon info-icon"><i class="fas fa-pencil-alt"></i></a>
                                <a href="deletarConsulta.html" class="action-icon edit-icon"><i class="fas fa-times"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td>2</td>
